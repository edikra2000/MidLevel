...
//Below you can find Example 1 as mentioned in task

//Example 1
const X = 2;
const Y = 2;
const numValidPaths = countValidPaths(X, Y);
const routes = findRoutes(X, Y);
console.log(`Example 1:
● Number of valid paths: ${numValidPaths}
● Routes for each valid path (Optional): ${routes.join(", ")}`);